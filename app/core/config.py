...
class Settings(BaseSettings):
    ...
    # AI Providers (openai / gemini / cohere / mock)
    EMBEDDING_PROVIDER: Literal["openai", "gemini", "cohere", "mock"] = "mock"
    LLM_PROVIDER: Literal["openai", "gemini", "cohere", "mock"] = "mock"
    ...
    COHERE_EMBEDDING_BATCH_SIZE: int = Field(default=96, ge=1, le=96)
    # API safety defaults
